...
public class ServicesController implements Initializable {
    ...
    private void editAction(ActionEvent event) {
        ...
        al.setTitle("Изменить услугу");
        al.setHeaderText("Изменяем услугу?");
        al.setContentText("Вы уверены, что хотите удалить услугу " + AddOrEditServicesController.service.getName() + "?");
