...
//    private TableColumn<Master, File> photoColumn;
    ...
    private void addAction(ActionEvent event) {
        ...
        stage.setTitle("Добавляем сотрудника");
        stage.show();
    }
    ...
    private void editAction(ActionEvent event) {
        ...
        al.setHeaderText("Изменяем сотрудника?");
        al.setContentText("Вы уверены что хотите изменить даные о сотруднике " + AddOrEditStaffController.master.getName() + "?");
        ...
        if (result.get() == ButtonType.OK){
            ...
            stage.initOwner(Salon.stage);
            stage.initModality(Modality.WINDOW_MODAL);
            stage.setTitle("Сотрудник добавлен");
            stage.show();
        } else {
            al.close();
        }
    ...
    private void deleteAction(ActionEvent event) {
        ...
        alert.setHeaderText("Удаляем сотрудника?");
